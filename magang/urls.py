...
urlpatterns = [
    ...
    path('dashboardpwkt/', user_views.dashboardpwkt, name='purwakarta'),
    path('dashboardjes/', user_views.dashboardjes, name='jes'),
    path('dashboardindogas/', user_views.dashboardindogas, name='indogas'),
    #----------------------------------Solusi-------------------------------------
